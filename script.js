...
const texts = [
    "Qualified Doctors &<br>Medical Specialist",
    "Fast & Reliable<br>Healthcare Services",
    "Trusted Local<br>Medical Professionals"
];
...
function rotateContent() {
    ...
    setTimeout(() => {
        ...
        rotatingText.innerHTML = texts[currentIndex];
